...
router.post('/', (req, res, next)=> {
  ...
  if(flag === 1){
    ...
    web3.eth.getTransactionCount(byAddress, (err,txCount) => {
      ...
      var data = certificateContract.methods.requestCertificationTo(certifyForAddress,byAddress,amount).encodeABI();
...
router.post('/send-back', (req, res, next)=> {
  ...
  if(flag === 1){
    ...
    web3.eth.getTransactionCount(certifyForAddress, (err,txCount) => {
      ...
      var data = certificateContract.methods.backEtherForCertification(certifyForAddress,byAddress,amountGivenBack).encodeABI();
